    ...
    faq: {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "記録の書き出しと復元に対応しています。設定からJSONファイルとして書き出し、新しい端末で読み込むと、メモ、タグ、スキー場、日記などの記録は引き継げます。ただしバックアップに動画ファイル自体は含まれないため、新しい端末では動画を再生できません。同じ端末でアプリを入れ直した場合は完全に元通りになります。",
            },
            {
